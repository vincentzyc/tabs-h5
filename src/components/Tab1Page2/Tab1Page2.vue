<template>
  ...
  <MarqueeSingle />
  <CountDown />
  <img src="@/assets/img/page2/tab1-2.jpg" alt="产品说明" class="widthfull mg-t10" />
  <img src="@/assets/img/page2/tab1-3.jpg" alt="产品说明" class="widthfull" />
...
import img4 from "@/assets/img/page2/tab1-4.png";
