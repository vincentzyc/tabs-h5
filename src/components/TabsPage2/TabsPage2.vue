<template>
  <div class="wg-tabs clearfix">
    <div v-show="mainStore.activeTab === 0">
      <img src="@/assets/img/page2/tab1-1.jpg" alt="靓号抢购" class="widthfull" />
    </div>
    <div v-show="mainStore.activeTab === 1">
      <img src="@/assets/img/page2/tab2-1.jpg" alt="靓号抢购" class="widthfull" />
    </div>
    <div v-show="mainStore.activeTab === 2">
      <img src="@/assets/img/page2/tab3-1.jpg" alt="靓号抢购" class="widthfull" />
    </div>
